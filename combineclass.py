...
class main_window:
    def __init__(self,root):
        ...
        #Add image file
        self.img = ImageTk.PhotoImage(file=r"C:\Users\sagir\OneDrive\Desktop\RAIT INTERNSHIP\Cab Booking Services\cab.jpeg")
        ...
        self.logo=ImageTk.PhotoImage(file=r"C:\Users\sagir\OneDrive\Desktop\RAIT INTERNSHIP\Cab Booking Services\images\logo.png")
...
# ========================================================================================================================
    def login(self):
        if self.username_entry.get()=='' or self.password_entry.get()=='':
            ...
            mydb=mysql.connector.connect(host='localhost',user='root',password='igotissues',database='cab_booking')
...
# ========================================================================================================================    
    ...
    def from_drop(self):
        ...
        self.cabs_frame=Frame(self.root,bg="black")
        self.cabs_frame.place(x=0,y=0,width=1600,height=900)


        self.cab_frame=Frame(self.root,bg="white")
        ...
        self.cal_frame=Frame(self.root,bg="olivedrab2",borderwidth=3)
        ...
        search_btn=Button(self.cabs_frame,text="BOOK MY CAB",cursor="hand2",font=("verdana","15","bold"),bg="olivedrab3",fg="black",command=self.from_drop_data)
        search_btn.place(x=1200,y=600)

        logout_btn=Button(self.cabs_frame,text="LOG OUT",cursor="hand2",font=("verdana","15","bold"),bg="olivedrab3",fg="black",command=self.root.destroy)
        logout_btn.place(x=1200,y=720)


        

        self.cab1=Image.open("images\cab1.png")
        self.cab_1=ImageTk.PhotoImage(self.cab1)
        cab_btn1=Button(self.cabs_frame,image=self.cab_1)
        cab_btn1.place(x=500,y=45)
        self.cab2=Image.open("images\cab2.png")
        self.cab_2=ImageTk.PhotoImage(self.cab2)
        cab_btn2=Button(self.cabs_frame,image=self.cab_2)
        cab_btn2.place(x=850,y=45)
        self.cab3=Image.open("images\cab3.png")
        self.cab_3=ImageTk.PhotoImage(self.cab3)
        cab_btn3=Button(self.cabs_frame,image=self.cab_3)
        cab_btn3.place(x=1200,y=45)
        self.cab4=Image.open("images\cab4.png")
        self.cab_4=ImageTk.PhotoImage(self.cab4)
        cab_btn4=Button(self.cabs_frame,image=self.cab_4)
        cab_btn4.place(x=500,y=265)
        self.cab5=Image.open("images\cab5.png")
        self.cab_5=ImageTk.PhotoImage(self.cab5)
        cab_btn5=Button(self.cabs_frame,image=self.cab_5)
        cab_btn5.place(x=850,y=265)
        self.cab6=Image.open("images\cab6.png")
        self.cab_6=ImageTk.PhotoImage(self.cab6)
        cab_btn6=Button(self.cabs_frame,image=self.cab_6)
        cab_btn6.place(x=1200,y=265)

        
        
        self.R1 = Radiobutton(self.cabs_frame, text="OLA MINI", variable=self.var1, value=1)
        self.R1.place(x=500,y=20)
        self.R2 = Radiobutton(self.cabs_frame, text="OLA PRIME SUDON", variable=self.var1, value=2)
        self.R2.place(x=850,y=20)
        self.R3 = Radiobutton(self.cabs_frame, text="OLA SUX", variable=self.var1, value=3)
        self.R3.place(x=1200,y=20)
        self.R4 = Radiobutton(self.cabs_frame, text="AUTO", variable=self.var1, value=4)
        self.R4.place(x=500,y=240)
        self.R5 = Radiobutton(self.cabs_frame, text="E-AUTO", variable=self.var1, value=5)
        self.R5.place(x=850,y=240)
        self.R6 = Radiobutton(self.cabs_frame, text="OLA SUV", variable=self.var1, value=6)
        self.R6.place(x=1200,y=240)

        self.fare_frame=Frame(self.root,bg="white")
        self.fare_frame.place(x=500,y=480,width=500,height=280)
        self.radio_1=IntVar()
        self.radio_3=IntVar()
        self.checkbox1=Checkbutton(self.fare_frame,text="AC",variable=self.var_check1,onvalue=1,offvalue=0,bg="olivedrab2",fg="black",command=self.hi(),font=("times new roman","15","bold"))
        self.checkbox1.place(x=20,y=30)
        self.checkbox2=Checkbutton(self.fare_frame,text="OLA PLAY",variable=self.var_check2,onvalue=1,offvalue=0,bg="olivedrab2",fg="black",command=self.hi(),font=("times new roman","15","bold"))
        self.checkbox2.place(x=20,y=130)
        self.checkbox3=Checkbutton(self.fare_frame,text='EXTRA LUGGAGE',variable=self.var_check3,onvalue=1,offvalue=0,bg="olivedrab2",fg="black",command=self.hi(),font=("times new roman","15","bold"))
        self.checkbox3.place(x=20,y=230)
 
        self.fare_tip_label=Label(self.fare_frame,text="TIP :",font=("calibri","15",'bold'),fg="black",bg="white")
        self.fare_tip_label.place(x=250,y=70)

        self.fare_tip_entry=Entry(self.fare_frame,font=("times new roman","12"),bg="olivedrab2",bd=1)
        self.fare_tip_entry.place(x=250,y=110,width=200,height=40)

        
        self.fare_button1=Button(self.cabs_frame,text="GENERATE RECEIPT",cursor="hand2",font=("verdana","15","bold"),bg="olivedrab3",fg="black",command=self.Receiptt)
        self.fare_button1.place(x=1200,y=660)
    ...
    def Receiptt(self):
        ...
        self.ReceiptFrame=Frame(self.root,bg='white')
        self.ReceiptFrame.place(x=0,y=0,height=450,width=450)

        # welcome_frame1=Frame(self.root,bg="black")
        # welcome_frame1.place(x=350,y=60,width=800,height=70)
        ...
        self.txtReceipt1 = Text(self.ReceiptFrame,width = 22, height = 21,font=('arial',10,'bold'),borderwidth=0)
        
        self.txtReceipt1.grid(row=0,column=0,columnspan=2)
        self.txtReceipt2 = Text(self.ReceiptFrame,width = 22, height = 21,font=('arial',10,'bold'),borderwidth=0)

        self.txtReceipt2.grid(row=0,column=2,columnspan=2)

    
        # if self.username_entry.get()!="" and self.L3_combo.get()="" and self.L4_combo.get()="" and self.cal.get()='' and  
        # self.cabtypefun()='' and self.hi()='' and self.fare_tip_entry.get()='' and self.ac()='' and self.olaplay()='' 
        # and self.extra_luggage()='' and self.sumoffare()=''and self.from_to_fare()='':
        ...
        self.txtReceipt2.insert(END, str(self.fare_sum) + "\n")
...
class Register:
    def __init__(self,root):
        ...
        #Add image file
        self.img2 = ImageTk.PhotoImage(file=r"C:\Users\sagir\OneDrive\Desktop\RAIT INTERNSHIP\Cab Booking Services\cab.jpeg")
        ...
        self.logo2=ImageTk.PhotoImage(file=r"C:\Users\sagir\OneDrive\Desktop\RAIT INTERNSHIP\Cab Booking Services\images\logo.png")
        ...
        login_img2=Image.open(r"images\logo.png")
